    ...
    <div className="relative max-w-4xl mx-auto py-8">
      ...
      >
        <div className="text-center mb-10">
          <h1 className="text-4xl font-bold text-white tracking-tight">Choose Your Avatar</h1>
        ...
        <Card className="p-8 border-indigo-500/20 bg-indigo-500/5">
                ...
                >
                  ...
                  {isSelected && (
                    <motion.div 
                      ...
                      className="absolute inset-0 rounded-2xl ring-2 ring-indigo-400 ring-offset-2 ring-offset-slate-900"
                    />
                  )}
                </motion.button>
              )
          ...
          <div className="flex justify-end pt-10 mt-8 border-t border-white/10">
            <Button 
              variant="primary" 
              size="lg"
